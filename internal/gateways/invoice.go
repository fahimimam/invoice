...
func NewGatewayForInvoice(grpcConn *grpc.ClientConn, certPEM, keyPEM, mspID string, invoiceConfig *config.Invoice) (*client.Gateway, *client.Contract, error) {
	...
	channelName := invoiceConfig.Channel
	chaincodeName := invoiceConfig.Channel
